...
import PreVagasForm from './PreVagasForm';
import { Testimonial, PreVagasFormData } from '../types';
...
const PreVagasPage: React.FC = () => {
    const [scrolled, setScrolled] = useState(false);
    const [formCompleted, setFormCompleted] = useState(false);
    const [submittedData, setSubmittedData] = useState<PreVagasFormData | null>(null);
    ...
    const handleFormComplete = async (data: PreVagasFormData) => {
    ...
    if (!formCompleted) {
        return (
            <>
                ...
                <PreVagasForm onComplete={handleFormComplete} />
            </>
        );
    }
